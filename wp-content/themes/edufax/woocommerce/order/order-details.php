...
<div class="woocommerce-order-details">
	...
	<h4 class="woocommerce-order-details__title tp-order-info-title"><?php esc_html_e('Order details', 'edufax'); ?></h4>
	...
	<div class="tp-order-info-list">
		<ul>
			...
			<li class="tp-order-info-list-header">
				<h4><?php esc_html_e('Product', 'edufax'); ?></h4>
				<h4><?php esc_html_e('Total', 'edufax'); ?></h4>
			</li>
			...
			?>
				...
				<li class="<?php echo esc_attr($class); ?>">
					...
					<span><?php echo edufax_kses($total['value']); ?></span>
				</li>
			<?php endforeach; ?>

			<?php if ($order->get_customer_note()) : ?>
				<li class="tp-order-info-list-note">
					<span><?php esc_html_e('Note:', 'edufax'); ?></span>
					<p><?php echo edufax_kses(nl2br(wptexturize($order->get_customer_note()))); ?></p>
				</li>
			<?php endif; ?>
