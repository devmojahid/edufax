...
<?php
	...
	$label = !empty($args['product_name']) ? sprintf(esc_html__('%s quantity', 'edufax'), wp_strip_all_tags($args['product_name'])) : esc_html__('Quantity', 'edufax');
?>
	<div class="tp-product-details-quantity">
		<div class="quantity tp-product-quantity">
			...
			<input type="text" id="<?php echo esc_attr($input_id); ?>" class="<?php echo esc_attr(join(' tp-cart-input ', (array) $classes)); ?>" step="<?php echo esc_attr($step); ?>" min="<?php echo esc_attr($min_value); ?>" max="<?php echo esc_attr(0 < $max_value ? $max_value : ''); ?>" name="<?php echo esc_attr($input_name); ?>" value="<?php echo esc_attr($input_value); ?>" title="<?php echo esc_attr_x('Qty', 'Product quantity input tooltip', 'edufax'); ?>" size="4" placeholder="<?php echo esc_attr($placeholder); ?>" inputmode="<?php echo esc_attr($inputmode); ?>" autocomplete="<?php echo esc_attr(isset($autocomplete) ? $autocomplete : 'on'); ?>" />
