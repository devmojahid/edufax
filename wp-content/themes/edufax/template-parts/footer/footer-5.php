...
$footer_bg_color = get_theme_mod('edufax_footer_bg_color', '#F5F5F5');
...
switch ($footer_columns) {
    ...
    case '4':
        ...
        $footer_class[3] = 'col-xl-3 col-lg-2 col-md-4 col-sm-5';
        $footer_class[4] = 'col-xl-4 col-lg-4 col-md-6 col-sm-7';
        break;
    default:
...
<footer>
    <div class="tp-footer-area tp-footer-style-2 tp-footer-style-3 tp-footer-style-4" data-bg-color="<?php print esc_attr($bg_color); ?>">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        if ($footer_columns < 5) {
                            ...
                            print '<div class="col-xl-3 col-lg-2 col-md-4 col-sm-5">';
                            dynamic_sidebar('footer-5-3');
                            print '</div>';

                            print '<div class="col-xl-4 col-lg-4 col-md-6 col-sm-7">';
