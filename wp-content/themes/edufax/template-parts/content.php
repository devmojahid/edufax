...
<!-- details end -->
<?php else : ?>
<article id="post-<?php the_ID(); ?>" data-wow-duration="1s"
    <?php post_class('tp-postbox-item tf__single_blog format-image mb-50 transition-3 tp-postbox-wrapper col-xl-5 col-md-5 wow fadeInUp mr_25'); ?>>
    ...
    <div class="tp-postbox-thumb tp-postbox-video tf__community_img">
        ...
        <div class="tf__community_img_overlay">
            <a href="<?php print esc_url($edufax_video_url); ?>" data-autoplay="true" data-vbtype="video"
                class="tp-postbox-video-btn popup-video venobox tf__play_btn"><i class="fas fa-play"></i></a>
        </div>
        <?php endif; ?>
    </div>
    <?php endif; ?>
