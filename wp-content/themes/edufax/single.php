							...
							<div class="col-xl-10">
								...
								<div class="postbox__meta-wrapper d-flex align-items-center justify-content-center flex-wrap">
										...
										<div class="postbox__meta-item mb-30">
											<div class="postbox__meta-author d-flex align-items-center">
												...
												<div class="postbox__meta-content">
													<span class="postbox__meta-type"><?php echo esc_html__('Author', 'edufax'); ?></span>
									...
									<?php if (!empty($edufax_blog_date)) : ?>
										<div class="postbox__meta-item mb-30">
											<div class="postbox__meta-content">
												<span class="postbox__meta-type"><?php echo esc_html__('Published', 'edufax'); ?></span>
									...
									<?php if (!empty($edufax_blog_comments)) : ?>
										<div class="postbox__meta-item mb-30">
											<div class="postbox__meta-content">
												...
												<p class="postbox__meta-name"><a href="<?php comments_link(); ?>"><?php echo esc_html__('Join the Conversation', 'edufax'); ?></a></p>
											</div>
										</div>
									<?php endif; ?>
									...
									<?php if (function_exists('getPostViews') && !empty($edufax_blog_view)) : ?>
										<div class="postbox__meta-item mb-30">
											<div class="postbox__meta-content">
												...
												<p class="postbox__meta-name"><?php echo getPostViews(get_the_ID()); ?> <?php echo esc_html__('views', 'edufax'); ?></p>
											</div>
										</div>
									<?php endif; ?>
							...
							<?php if (has_post_thumbnail()) : ?>
								<div class="tp-postbox-details-thumb tp-postbox-details-video">
									...
									<?php if (!empty($edufax_video_url)) : ?>
										<a href="<?php print esc_url($edufax_video_url); ?>" class="tp-postbox-video-btn popup-video"><i class="fas fa-play"></i></a>
									<?php endif; ?>
								</div>
							<?php endif; ?>
