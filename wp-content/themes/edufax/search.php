				...
				<div class="tp-postbox-wrapper pr-50">
					...
					?>
						<div class="result-bar page-header d-none">
							<h1 class="page-title"><?php esc_html_e('Search Results For:', 'edufax'); ?> <?php print get_search_query(); ?></h1>
						</div>
						<?php
						...
						<div class="tp-pagination">
							<?php edufax_pagination('<i class="fas fa-angle-double-left"></i>', '<i class="fas fa-angle-double-right"></i>', '', ['class' => '']); ?>
						</div>
					<?php
					else :
