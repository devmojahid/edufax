...
<?php if (have_comments() || comments_open()) : ?>
    <div id="comments" class="blog-post-comment tp-postbox-details-comment-wrapper">
        ...
        <?php if (get_comment_pages_count() > 1 && get_option('page_comments')) : ?>
            <div class="comment-pagination mb-50 d-none">
                <nav id="comment-nav-below" class="comment-navigation" role="navigation">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="nav-previous "><?php previous_comments_link(esc_html__('&larr; Older ', 'edufax')); ?></div>
                        </div>
                        <div class="col-md-6">
        ...
        $fields = array(
            'author' => '<div class="row"><div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6"><div class="tp-postbox-details-input-box"> <div class="tp-postbox-details-input"> <input placeholder="' .  esc_attr__('Enter Name', 'edufax') . '" id="author" class="tp-form-control" name="author" type="text" value="' . esc_attr($commenter['comment_author']) . '" size="30"' . $aria_req . ' /></div></div></div>',

            'email'  => '<div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6"><div class="tp-postbox-details-input-box"> <div class="tp-postbox-details-input"> <input placeholder="' .  esc_attr__('Enter Email', 'edufax') . '" id="email" name="email" class="tp-form-control" type="email" value="' . esc_attr($commenter['comment_author_email']) . '" size="30"' . $aria_req . ' /></div></div></div>',

            'url'    => '<div class="col-xxl-4 col-xl-4 col-lg-12"><div class="tp-postbox-details-input-box"><div class="tp-postbox-details-input"><input placeholder="' .  esc_attr__('Enter Website', 'edufax') . '" id="url" name="url" class="tp-form-control" type="url" value="' . esc_attr($commenter['comment_author_url']) . '" size="30" /></div></div></div></div>'
        );
        ...
        $defaults = [
            ...
            <div class="row post-input">
                <div class="col-md-12 ' . $cl . '">
                    <div class="tp-postbox-details-input-box"><div class="tp-postbox-details-input"><textarea class="tp-form-control msg-box" placeholder="' .  esc_attr__('Enter Your Comment', 'edufax') . '" id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea>
                </div></div></div>
                <div class="clearfix"></div>
            </div>
        ',
            'submit_button'    => '<div class="col-xl-12"><button class="tp-btn" type="submit">' . esc_html__('Post Comment', 'edufax') . ' </button></div>',
