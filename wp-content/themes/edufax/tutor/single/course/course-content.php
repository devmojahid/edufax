...
if ( tutor_utils()->get_option( 'enable_course_about', true, true ) ) {
	...
	?>
<?php if ( ! empty( $string ) ) : ?>
<div class="tf__course_overview tutor-course-details-content<?php echo $has_show_more ? ' tutor-toggle-more-content tutor-toggle-more-collapsed' : ''; ?>"
    <?php echo $has_show_more ? ' data-tutor-toggle-more-content data-toggle-height="200" style="height: 200px;"' : ''; ?>>
