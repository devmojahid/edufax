...
<div class="tutor-card-body">
    ...
    <ul class="list">
        ...
        <li class="tutor-d-flex<?php echo $key > 0 ? ' tutor-mt-12' : ''; ?>">
            <span aria-labelledby="<?php echo esc_html($meta['label']); ?>">
                <i class="<?php echo esc_attr($meta['icon_class']); ?>"></i> <?php echo esc_html($meta['label']); ?>
            </span>
    ...
    <div class="tutor-course-progress-wrapper tutor-mb-32">
        ...
        <div class="list-item-progress">
            ...
            <div class="tutor-progress-bar tutor-mt-12"
                style="--tutor-progress-value:<?php echo esc_attr($completed_percent); ?>%;">
    ...
    <?php
			...
			?>
    <button type="button"
        class="tf__common_btn tutor-btn-outline-primary start-continue-retake-button tutor-course-retake-button"
        href="<?php echo esc_url($lesson_url); ?>" data-course_id="<?php echo esc_attr(get_the_ID()); ?>">
    ...
    <?php
				...
				?>
    <a href="<?php echo esc_url($lesson_url); ?>" class="tf__common_btn tutor-mt-20">
    ...
    <form method="post" class="tutor-mt-20">
        ...
        <button type="submit" class="tf__common_btn2" name="complete_course_btn" value="complete_course">
    ...
    <?php
			...
			ob_start();
		?>
    <a href="<?php echo esc_url($first_lesson_url); ?>" class="tf__common_btn">
    ...
    <div class="tutor-course-single-btn-group <?php echo is_user_logged_in() ? '' : 'tutor-course-entry-box-login'; ?>"
        data-login_url="<?php echo esc_url($login_url); ?>">
        <form class="tutor-enrol-course-form" method="post">
            <?php wp_nonce_field(tutor()->nonce_action, tutor()->nonce); ?>
            <input type="hidden" name="tutor_course_id" value="<?php echo esc_attr(get_the_ID()); ?>">
            <input type="hidden" name="tutor_course_action" value="_tutor_course_enroll_now">
            <button type="submit" class="tf__common_btn tutor-mt-24 tutor-enroll-course-button tutor-static-loader">
