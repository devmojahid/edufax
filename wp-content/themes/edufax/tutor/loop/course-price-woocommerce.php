...
<div class="tutor-course-loop-price">
    ...
    $enroll_btn = '<div  class="tutor-public-course-start-learning">' . apply_filters('tutor_course_restrict_new_entry', '<a href="' . get_the_permalink() . '">' . __('Get Enrolled', 'educal') . '</a>') . '</div>';
    $default_price = apply_filters('tutor-loop-default-price', ($is_public ? '' : __('Free', 'educal')));
