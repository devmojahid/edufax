											...
											<div class="etn-event-content">
													...
													<div class="etn-event-footer">
															...
															<div class="etn-atend-btn">
																	<a href="<?php echo esc_url(get_the_permalink($value->ID)); ?>" class="etn-btn etn-btn-border" title="<?php echo get_the_title($value->ID); ?>"><?php echo esc_html__('attend', 'poorex') ?> <i class="etn-icon etn-arrow-right"></i></a>
															</div>
													</div>
											</div>
									</div>
