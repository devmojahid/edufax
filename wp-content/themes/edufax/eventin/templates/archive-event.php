...
<div class="main-event-archive pt-100 pb-100 ddd">
    ...
    <div class="etn-event-archive-wrap etn_search_item_container" data-json='<?php echo json_encode([
        "error_content" => [
            "title" => esc_html__('Nothing found!', 'poorex'),
            "exerpt" => esc_html__('It looks like nothing was found here. Maybe try a search?','poorex')
        ]
    ]); ?>'>
        <div class="etn-container">
            ...
            if (have_posts()) {
                ...
                ?>
                <p><?php echo esc_html('No Event found!', 'poorex'); ?></p>
                <?php
            }
            ?>
