 ...
 * @since 1.0.0
 */
class MS_Mega_Menu_List extends Widget_Base
{
    ...
    {
        return __('Mega Menu List', 'mscore');
    }
    ...
    protected function register_controls_section()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Shop Pages', 'mscore'),
...
?>
        ...
        <div class="shop-mega-menu-list">
            <span class="shop-mega-menu-title "><?php echo esc_html($settings['menu_list_title']); ?></span>
            <?php echo $menu_html; ?>
        </div>
...
$widgets_manager->register(new MS_Mega_Menu_List());
