...
use \MS_ELEMENTOR\Templates\MS_Api;
use \MS_ELEMENTOR\Templates\MS_Templates as MS_init;
...
class MS_Load
{
    ...
    {
        $ajax->register_ajax_action('get_mscore_library_data', function ($data) {
