 ...
 * @since 1.0.0
 */
class MS_Header_03 extends Widget_Base
{
    ...
    {
        return __('Header Builder Style 3', 'mscore');
    }
...
?>
        ...
        <!-- header area start -->
        <header>
            <div id="header-sticky" class="ms-header-area ms-header-style-transparent-white ms-header-transparent ms-header-sticky has-dark-logo ms-header-height">
                <div class="ms-header-bottom-3 pl-35 pr-35">
                            ...
                            <div class="col-xl-2 col-lg-2 col-6">
                                <div class="ms-header-action d-flex align-items-center justify-content-end ml-50">
                                    <?php if ($settings['ms_header_right_switch'] === 'yes') : ?>
                                        ...
                                        <?php if ((($settings['ms_header_wishlist_switch'] === 'yes') || ($settings['ms_header_cart_switch'] === 'yes')) && class_exists('WooCommerce')) : ?>
...
$widgets_manager->register(new MS_Header_03());
