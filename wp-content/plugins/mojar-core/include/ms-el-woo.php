...
class MS_El_Woocommerce
{
    ...
    public static function ms_woo_add_to_cart($args = array())
    {
        global $product;
    ...
    public static function add_to_cart_button($product_id)
    {
        ...
        if ($product) {
            ...
            return sprintf(
                '<a rel="nofollow" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s add_to_cart_button ms-btn"><i class="fal fa-shopping-cart"></i> Add To Cart</a>',
                esc_url($product->add_to_cart_url()),
