...
trait TPCoreElementFunctions
{
    ...
    */
    protected function tp_button_render_controls($control_id = 'button', $control_name = 'Button', $control_condition = 'layout-1' ,  $default_btn_text = 'Read More', $default_btn_enable = 'yes')
    {
    ...
    */
    protected function tp_section_title_render_controls($control_id = null, $section_name = 'Section Title', $condition = ['layout-1', 'layout-2', 'layout-3', 'layout-4', 'layout-5', 'layout-6', 'layout-7', 'layout-8', 'layout-9', 'layout-10'] ,  $sub_title = 'Sub Title', $default_title = 'Your Section Title', $default_description = 'There are many variations of passages of Lorem Ipsum available, <br /> but the majority have suffered alteration.', $default_title_tag = 'h2', $default_align = 'text-left',  $enable_section_title_show_hide = true, $default_section_title_enable = 'yes')
    {
        $this->start_controls_section(
    ...
    */
    ...
    protected function tp_post_layout($control_id = null, $control_name = null){
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Blog Slider 1', 'tpcore'),
                    'layout-2' => esc_html__('Blog Box', 'tpcore'),
                ],
                'default' => 'layout-1',
            ]
        );
    ...
    protected function tp_product_layout($control_id = null, $control_name = null){
        $this->start_controls_section(
            'tp_'. $control_id .'_',
            [
                'label' => sprintf(esc_html__('%s - Layout', 'tpcore'), $control_name),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Product Offer', 'tpcore'),
                    'layout-2' => esc_html__('Product Simple', 'tpcore'),
                    'layout-3' => esc_html__('Product Arrival', 'tpcore'),
                    'layout-4' => esc_html__('Product SM List', 'tpcore'),
                    'layout-5' => esc_html__('Product Slider Trending', 'tpcore'),
                    'layout-6' => esc_html__('Product Weeks Featured', 'tpcore'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        if(false){
            ...
            $this->add_control(
            'tp_'. $control_id .'__slides_per_view',
             [
            ...
            $this->add_control(
            'tp_'. $control_id .'__slides_per_view_lg',
             [
            ...
            $this->add_control(
            'tp_'. $control_id .'__slides_per_view_md',
             [
            ...
            $this->add_control(
            'tp_'. $control_id .'__slides_per_view_sm',
             [
            ...
            $this->add_control(
            'tp_'. $control_id .'__slides_per_view_xs',
             [
    ...
    protected function tp_product_badges(){
        $this->start_controls_section(
            'tp_product_badge_sec',
               [
                 'label' => esc_html__( 'Badge Controls', 'tpcore' ),
                 'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
               ]
           );
           ...
           $this->add_control(
            'product_trending_badge_enable',
              [
                 'label'        => esc_html__( 'Enable Trending Badge ?', 'tpcore' ),
                 'type'         => \Elementor\Controls_Manager::SWITCHER,
                 'label_on'     => esc_html__( 'Show', 'tpcore' ),
                 'label_off'    => esc_html__( 'Hide', 'tpcore' ),
                 'return_value' => 'yes',
           ...
           $this->add_control(
               'product_badge_type',
              [
                 'label'   => esc_html__( 'Product Badge Type', 'tpcore' ),
                 'type' => \Elementor\Controls_Manager::SELECT,
                 'options' => [
                       'sales'  => esc_html__( 'Based On Sales', 'tpcore' ),
                       'rating'  => esc_html__( 'Based On Rating', 'tpcore' ),
                       'review'  => esc_html__( 'Based On Review', 'tpcore' ),
                       'views'  => esc_html__( 'Based On Views', 'tpcore' ),
                    ],
                 'default' => 'sales',
                 'condition' => [
           ...
           'sale_count_to_show',
            [
              'label'       => esc_html__( 'Sales Count', 'tpcore' ),
              'type'        => \Elementor\Controls_Manager::TEXT,
              'default'     => esc_html__( '10', 'tpcore' ),
              'placeholder' => esc_html__( 'Count Number', 'tpcore' ),
              'description' => esc_html__( 'How many sales are required to show it', 'tpcore' ),
              'condition' => [
           ...
           'rating_count_to_show',
            [
              'label'       => esc_html__( 'Rating Count', 'tpcore' ),
              'type'        => \Elementor\Controls_Manager::TEXT,
              'default'     => esc_html__( '5', 'tpcore' ),
              'placeholder' => esc_html__( 'Rating Count Number', 'tpcore' ),
              'description' => esc_html__( 'How many ratings are required to show it', 'tpcore' ),
              'condition' => [
           ...
           'review_count_to_show',
            [
              'label'       => esc_html__( 'Reviews Count', 'tpcore' ),
              'type'        => \Elementor\Controls_Manager::TEXT,
              'default'     => esc_html__( '3', 'tpcore' ),
              'placeholder' => esc_html__( 'Review Count', 'tpcore' ),
              'description' => esc_html__( 'How many reviews are required to show it', 'tpcore' ),
              'condition' => [
           ...
           'view_count_to_show',
            [
              'label'       => esc_html__( 'Views Count', 'tpcore' ),
              'type'        => \Elementor\Controls_Manager::TEXT,
              'default'     => esc_html__( '10', 'tpcore' ),
              'placeholder' => esc_html__( 'Views Count', 'tpcore' ),
              'description' => esc_html__( 'How many views are required to show it', 'tpcore' ),
              'condition' => [
           ...
           $this->add_control(
              'product_hot_badge_enable',
                 [
                    'label'        => esc_html__( 'Enable Hot Badge?', 'tpcore' ),
                    'type'         => \Elementor\Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Show', 'tpcore' ),
                    'label_off'    => esc_html__( 'Hide', 'tpcore' ),
                    'return_value' => 'yes',
              ...
              $this->add_control(
                 'date_diff_to_show',
                 [
                    'label'       => esc_html__( 'Date Count', 'tpcore' ),
                    'type'        => \Elementor\Controls_Manager::TEXT,
                    'default'     => esc_html__( '10', 'tpcore' ),
                    'placeholder' => esc_html__( 'Date Count', 'tpcore' ),
                    'description' => esc_html__( 'How many days from uploaded are going to showing it.', 'tpcore' ),
                    'condition' => [
    ...
    protected function tp_post_result_count($query, $settings = null){
        ...
        // var_dump($current);
        if ( 1 === intval( $total ) ) {
              _e( 'Showing the single result', 'tpcore' );
        } elseif ( $total <= $per_page || -1 === $per_page ) {
              /* translators: %d: total results */
              printf( _n( 'Showing all %d result', 'Showing all %d results', $total, 'tpcore' ), $total );
        } else {
              ...
              printf( _nx( 'Showing %1$d&ndash;%2$d of %3$d result', 'Showing %1$d&ndash;%2$d of %3$d results', $total, 'with first and last result', 'tpcore' ), $first, $last, $total );
        }
