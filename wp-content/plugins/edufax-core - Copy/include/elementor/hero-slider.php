                           ...
                           <div class="col-xl-6 col-lg-6 col-md-6">
                              <div class="tp-slider-content-2">
                                ...
                                <div class="tp-slider-btn-2">
                                    <a target="<?php echo esc_attr($target); ?>" rel="<?php echo esc_attr($rel); ?>" href="<?php echo esc_url($link); ?>"  class="tp-btn tp-btn-border"><?php echo tp_kses($item['tp_btn_btn_text']); ?></a>
                                </div>
                                <?php endif; ?>                                     
                              ...
                              <div class="tp-slider-content-3">
                                ...
                                <?php endif; ?> 
                                 ...
                                 <div class="tp-slider-btn-3">
                                    <a target="<?php echo esc_attr($target); ?>" rel="<?php echo esc_attr($rel); ?>" href="<?php echo esc_url($link); ?>" class="tp-btn tp-btn-border tp-btn-border-white"><?php echo tp_kses($item['tp_btn_btn_text']); ?></a>
                                 </div>
                                 <?php endif; ?>                               
                              </div>
                           </div>
         ...
         <section class="tp-slider-area p-relative z-index-1">
            <div class="tp-slider-active tp-slider-variation swiper-container">
               ...
               <div class="swiper-wrapper">
                    ...
                    ?> 
                  <div class="tp-slider-item tp-slider-height d-flex align-items-center swiper-slide <?php echo esc_attr($light_class ); ?>">
                              ...
                              <div class="tp-slider-content p-relative z-index-1">
                                ...
                                <?php if (!empty($link)) : ?>
                                 <div class="tp-slider-btn">
                                    <a target="<?php echo esc_attr($target); ?>" rel="<?php echo esc_attr($rel); ?>" href="<?php echo esc_url($link); ?>" class="tp-btn tp-btn-2 tp-btn-white">
