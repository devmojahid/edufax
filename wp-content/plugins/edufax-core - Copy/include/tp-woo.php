                ...
                <div class="col-xl-6">
                    ...
                    <div class="tp-coupon-item-left d-sm-flex align-items-center">
                        ...
                        <div class="tp-coupon-content">
                            ...
                            <?php if($type === 'percent'): ?>
                            <p class="tp-coupon-offer mb-15"><span><?php echo esc_html($ammount) . esc_html__('%', 'shofy');?></span><?php echo esc_html__('Off', 'shofy'); ?></p>
                            <?php else: ?>
                                <p class="tp-coupon-offer mb-15"><span><?php echo esc_html($ammount) . esc_html($currencySymbol); ?></span><?php echo esc_html__('Off', 'shofy'); ?></p>
                            <?php endif; ?>
