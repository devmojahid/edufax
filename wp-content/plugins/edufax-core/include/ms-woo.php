...
?>
    ...
    <div class="ms-coupon-area pb-120">
        <div class="container">
            <div class="row">
                ...
                <?php foreach ($coupons as $coupon) :
                    ...
                    $date = date("M d Y h:m:i", strtotime($coupon_details->get_date_expires()));
                ...
                ?>
                    <div class="col-xl-6">
                        <div class="ms-coupon-item mb-30 p-relative d-md-flex justify-content-between align-items-center">
                            <span class="ms-coupon-border"></span>
                            <div class="ms-coupon-item-left d-sm-flex align-items-center">

                                <?php if (!empty($img)) : ?>
                                    <div class="ms-coupon-thumb">
                                        <img alt="logo" src="<?php echo esc_url($img); ?>">
                                    </div>
                                <?php endif; ?>

                                <div class="ms-coupon-content">

                                    <?php if (!empty($title)) : ?>
                                        <h3 class="ms-coupon-title"><?php echo esc_html($title); ?></h3>
                                    <?php endif; ?>

                                    <?php if ($type === 'percent') : ?>
                                        <p class="ms-coupon-offer mb-15"><span><?php echo esc_html($ammount) . esc_html__('%', 'shofy'); ?></span><?php echo esc_html__('Off', 'shofy'); ?></p>
                                    <?php else : ?>
                                        <p class="ms-coupon-offer mb-15"><span><?php echo esc_html($ammount) . esc_html($currencySymbol); ?></span><?php echo esc_html__('Off', 'shofy'); ?></p>
                                    <?php endif; ?>
                                    <div class="ms-coupon-countdown" data-countdown="" data-date="<?php echo esc_attr($date); ?>">
                                        <div class="ms-coupon-countdown-inner">
                                            <ul>
                            ...
                            <div class="ms-coupon-item-right pl-20">
                                <div class="ms-coupon-status mb-10 d-flex align-items-center">
                                    <?php
                                    $text = $date_diff ? 'active' : 'Expired';
                                    ?>
                                    <h4><?php echo esc_html__('Coupon :', 'shofy'); ?> <span class="<?php echo esc_attr($text); ?>"><?php echo esc_html($text); ?></span></h4>

                                    <?php if (!empty($desc)) : ?>
                                        <div class="ms-coupon-info-details">
                                            <span>
                                            ...
                                            <div class="ms-coupon-info-tooltip transition-3">
                                ...
                                <?php if (!empty($code)) : ?>
                                    <div class="ms-coupon-date"><button><span><?php echo esc_html($code); ?></span></button></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
