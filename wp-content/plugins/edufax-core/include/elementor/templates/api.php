...
use MS_ELEMENTOR\Templates\MS_Api as TemplatesMS_Api;
...
class MS_Api extends Source_Base
{
	...
	{
		return __('MS Addons Library', 'mscore');
	}
	...
	{
		$response	=	wp_remote_get(MS_API_URL . 'data.json', ['timeout' => 60]);
	...
	public static function request_template_data($template_id)
	{
		...
		$template_url = sprintf(MS_API_URL . "templates/%s.json", $template_id);
