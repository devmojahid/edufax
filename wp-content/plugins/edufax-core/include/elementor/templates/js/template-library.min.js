!function ($, $ele, $i) {
    window.liteTranslated = function (e, t) {
        return elementorCommon.translate(e, null, t, mscoreEditor.i18n)
    };
    ...
    $app.Models.Template = Backbone.Model.extend({
        ...
        $app.Views.EmptyTemplateCollection = Marionette.ItemView.extend({
            ...
            template: "#mscore-liteTemplateLibrary_empty",
            ui: {
        ...
        $app.Views.Loading = Marionette.ItemView.extend({
            template: "#mscore-liteTemplateLibrary_loading",
            id: "liteTemplateLibrary_loading"
        }),
        $app.Views.Logo = Marionette.ItemView.extend({
            template: "#mscore-harry-template-library-header-logo",
        ...
        $app.Views.BackButton = Marionette.ItemView.extend({
            template: "#mscore-liteTemplateLibrary_header-back",
        ...
        $app.Views.Menu = Marionette.ItemView.extend({
            template: "#mscore-liteTemplateLibrary_header-menu",
        ...
        $app.Views.ResponsiveMenu = Marionette.ItemView.extend({
            template: "#mscore-liteTemplateLibrary_header-menu-responsive",
        ...
        $app.Views.Actions = Marionette.ItemView.extend({
            template: "#mscore-liteTemplateLibrary_header-actions",
        ...
        $app.Views.InsertWrapper = Marionette.ItemView.extend({
            template: "#mscore-liteTemplateLibrary_header-insert",
        ...
        $app.Views.Preview = Marionette.ItemView.extend({
            template: "#mscore-liteTemplateLibrary_preview",
        ...
        $app.Views.TemplateCollection = Marionette.CompositeView.extend({
            template: "#mscore-liteTemplateLibrary_templates",
        ...
        $app.Views.Template = Marionette.ItemView.extend({
            template: "#mscore-liteTemplateLibrary_template",
        ...
        $app.Modal = elementorModules.common.views.modal.Layout.extend({
            ...
            getTemplateActionButton: function (e) {
                var t = e.isPro && !mscoreEditor.hasPro ? "pro-button" : "insert-button";
                return viewId = "#mscore-liteTemplateLibrary_" + t, template = Marionette.TemplateCache.get(viewId), Marionette.Renderer.render(template)
            },
            showLogo: function (e) {
        ...
        $app.Manager = function () {
            ...
            function addButton() {
                ...
                }), $sl.find(".ms_templates_add_button").length || $sl.find(DROIT_FIND_SELECTOR).before($mscorePpenLibraryButton)
            }

            function initAddButton($el) {
                var $t = $el.find(DROIT_FIND_SELECTOR);
                $t.length && !$el.find(".ms_templates_add_button").length && $t.before($mscorePpenLibraryButton), $el.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", addButton)
            }
            ...
            function onEditorLoaded() {
                ...
                $el.on("click.onAddTemplateButton", ".ms_templates_add_button", $this.showModal.bind($this)), this.channels.tabs.on("change:device", onChanges)
            }
            ...
            DROIT_FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title",
                $mscorePpenLibraryButton = '<div class="elementor-add-section-area-button ms_templates_add_button"> <img src="' + mscoreEditor.templateLogo + '" /> </div>',
                $tpResponsiveMap = {
                    desktop: "100%",
                    tab: "768px",
                    mobile: "360px"
                ...
                this.init = function () {
                    $this.setFilter("type", mscoreEditor.default_tab, !0), $ele.on("preview:loaded", onEditorLoaded.bind(this))
                },
                this.getTabs = function () {
                    var e = this.getFilter("type");
                    return tabs = JSON.parse(mscoreEditor.tab_style)
                ...
                this.requestLibraryData = function (e) {
                    ...
                    e.forceSync && (t.data.sync = !0), elementorCommon.ajax.addRequest("get_mscore_library_data", t)
                },
                this.requestTemplateData = function (e, t) {
                    ...
                    t && jQuery.extend(!0, i, t), elementorCommon.ajax.addRequest("get_mscore_template_data", i)
                },
...
}(jQuery, window.elementor, window.mscore || {});
