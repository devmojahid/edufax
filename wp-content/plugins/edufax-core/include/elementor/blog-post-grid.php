 ...
 * @since 1.0.0
 */
class MS_Blog_Post_Grid extends Widget_Base
{
   ...
   {
      return __('Blog Post Grid', 'mscore');
   }
   ...
   protected function register_controls_section()
   {
      ...
      $this->ms_section_title_render_controls('blog', 'Section Title', 'Sub Title', 'your title here', $default_description = 'Hic nesciunt galisum aut dolorem aperiam eum soluta quod ea cupiditate.');

      // Blog Query
      $this->ms_query_controls('blog', 'Blog');

      // layout Panel
      $this->ms_post_layout_2('post', 'Blog');
   }
   ...
   protected function style_tab_content()
   {
      ...
      $this->ms_basic_style_controls('blog_subtitle', 'Section - Subtitle', '.ms-el-subtitle');
      $this->ms_basic_style_controls('blog_title', 'Section - Title', '.ms-el-title');
      $this->ms_basic_style_controls('blog_description', 'Section - Description', '.ms-el-content p');

      $this->ms_basic_style_controls('blog_box_title', 'Blog - Box - Title', '.ms-el-box-title');
      $this->ms_basic_style_controls('blog_box_desc', 'Blog - Box - Description', '.ms-el-box-desc');
      $this->ms_link_controls_style('blog_box_tag', 'Blog - Box - Tag', '.ms-el-box-tag');
      $this->ms_link_controls_style('blog_box_meta', 'Blog - Box - Meta', '.ms-el-box-meta span');
      $this->ms_link_controls_style('blog_box_btn', 'Blog - Box - Button', '.ms-el-box-btn');
   }
...
?>
      ...
      ?>
         ...
         <section class="ms-blog-grid-area pb-120">
            <div class="container">
               <div class="row">
                  <div class="<?php echo esc_attr(($blog_column)); ?> <?php echo esc_attr(($$blog_column_align)); ?>">
                     <div class="ms-blog-grid-wrapper">
                        <div class="ms-blog-grid-top d-flex justify-content-between mb-40">
                           <div class="ms-blog-grid-result">
                              <p><?php $this->ms_post_result_count($query, $settings) ?></p>
                           </div>
                           <div class="ms-blog-grid-tab ms-tab">
                              <nav>
                        ...
                        <?php if ($query->have_posts()) : ?>
                           <div class="tab-content" id="nav-tabContent">
                              <div class="tab-pane fade show active" id="nav-grid" role="tabpanel" aria-labelledby="nav-grid-tab" tabindex="0">
                                 ...
                                 <div class="ms-blog-grid-item-wrapper">
                                    <div class="row ms-gx-30 grid">
                                       ...
                                       <?php if ($query->have_posts()) :
                                          while ($query->have_posts()) :
                                             ...
                                             $has_thumbnail = has_post_thumbnail() ? "" : "ms-no-thumbnail";
                                       ?>

                                             <div class="col-lg-6 col-md-6 grid-item">
                                                <div class="ms-blog-grid-item p-relative mb-30 <?php echo esc_attr($has_thumbnail); ?>">
                                                   <?php if (has_post_thumbnail()) : ?>
                                                      <div class="ms-blog-grid-thumb w-img fix mb-30">
                                                         <a href="<?php the_permalink(); ?>">
                                                            <?php the_post_thumbnail($post->ID, $settings['thumbnail_size']); ?>
                                                         </a>
                                                      </div>
                                                   <?php endif; ?>
                                                   <div class="ms-blog-grid-content">
                                                      <div class="ms-blog-grid-meta">
                                                         <span>
                                                            <span>
                                                         ...
                                                         <span>
                                                            ...
                                                            <?php echo esc_html__('Comments ', 'shofy');
                                                            echo "(" . get_comments_number($post->ID) . ")"; ?>
                                                         </span>
                                                      </div>
                                                      <h3 class="ms-blog-grid-title">
                                                      ...
                                                      <?php if (!empty($settings['ms_post_button'])) : ?>
                                                         <div class="ms-blog-grid-btn">
                                                            <a href="<?php the_permalink(); ?>" class="ms-link-btn-3">
                              ...
                              <div class="tab-pane fade" id="nav-list" role="tabpanel" aria-labelledby="nav-list-tab" tabindex="0">
                                 <!-- blog list wrapper -->
                                 <div class="ms-blog-list-item-wrapper">
                                    <?php if ($query->have_posts()) :
                                       while ($query->have_posts()) :
                                          $query->the_post();
                                          global $post;
                                          ...
                                          $has_thumbnail = has_post_thumbnail() ? "" : "ms-no-thumbnail";
                                    ?>
                                          <div class="ms-blog-list-item d-md-flex d-lg-block d-xl-flex">
                                             <?php if (has_post_thumbnail()) : ?>
                                                <div class="ms-blog-list-thumb">
                                                   <a href="<?php the_permalink(); ?>">
                                                      <?php the_post_thumbnail($post->ID, $settings['thumbnail_size']); ?>
                                                   </a>
                                                </div>
                                             <?php endif; ?>
                                             <div class="ms-blog-list-content">
                                                <div class="ms-blog-grid-content">
                                                   <div class="ms-blog-grid-meta">
                                                      <span>
                                                         <span>
                              ...
                              <div class="row">
                                 <div class="col-xl-12">
                                    <div class="ms-blog-pagination mt-30">
                                       <div class="ms-pagination">
                                          <?php if (($settings['ms_post__pagination'] == 'yes') && ('-1' != $settings['posts_per_page'])) : ?>
                                             <?php
                                             $big = 999999999;
                  ...
                  <?php if (is_active_sidebar('blog-sidebar') && ($settings['enable_sidebar'] == 'yes')) : ?>
                     <div class="col-xl-3 col-lg-4">
                        <div class="ms-sidebar-wrapper ms-sidebar-ml--24 ">
                           <?php get_sidebar(); ?>
                        </div>
                     </div>
                  <?php endif; ?>
...
$widgets_manager->register(new MS_Blog_Post_Grid());
