 ...
 * @since 1.0.0
 */
class MS_App_Download extends Widget_Base
{
    ...
    protected function register_controls_section()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Get the app & get Your Groceries from home', 'mscore'),
        ...
        $this->ms_button_render_controls('tpbtn', 'Play Store Button', ['layout-1']);
        $this->ms_button_render_controls('tpbtn2', 'App Strore Button', ['layout-1']);
...
?>
        ...
        <?php else :
            $control_id = 'tpbtn';
            $control_id_2 = 'tpbtn2';
            $this->ms_link_controls_render('tpbtn', 'd-flex align-items-center google-btn', $this->get_settings());
            $this->ms_link_controls_render('tpbtn2', 'd-flex align-items-center apple-btn', $this->get_settings());

            if (!empty($settings['ms_app_image']['url'])) {
                $ms_app_image_url = !empty($settings['ms_app_image']['id']) ? wp_get_attachment_image_url($settings['ms_app_image']['id'], $settings['thumbnail_size']) : $settings['ms_app_image']['url'];
                $ms_app_image_alt = get_post_meta($settings["ms_app_image"]["id"], "_wp_attachment_image_alt", true);
            }
        ?>


            <!-- cta area start -->
            <section class="ms-cta-area fix pt-50 p-relative z-index-1 ">
                <div class="ms-cta-inner p-relative pt-80 pb-55 cta-green-bg">
                    <?php if ($settings['ms_app_shape'] == 'yes') : ?>
                        <div class="ms-cta-shape">
                            <img class="ms-cta-shape-1" src="<?php echo get_template_directory_uri(); ?>/assets/img/cta/shape/cta-shape-1.png" alt="<?php echo esc_attr($bloginfo); ?>">
                            <img class="ms-cta-shape-2" src="<?php echo get_template_directory_uri(); ?>/assets/img/cta/shape/cta-shape-2.png" alt="<?php echo esc_attr($bloginfo); ?>">
                        </div>
                    <?php endif;  ?>
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-7">
                                <div class="ms-cta-wrapper p-relative z-index-1">

                                    <?php if (!empty($settings['ms_text_title'])) : ?>
                                        <h3 class="ms-cta-title"><?php echo esc_html($settings['ms_text_title']); ?></h3>
                                    <?php endif; ?>

                                    <div class="ms-cta-btn-wrapper d-flex flex-wrap">
                                        <!-- button start -->
                                        <?php if ($settings['ms_' . $control_id . '_button_show'] == 'yes') : ?>
                                            <div class="ms-app-btn mb-30">
                                                <a <?php echo $this->get_render_attribute_string('ms-button-arg'); ?>>
                                                    ...
                                                    <div class="app-content">
                                                        <span><?php echo esc_html__('Get it on', 'mscore'); ?></span>
                                                        <p><?php echo $settings['ms_' . $control_id . '_text']; ?></p>
                                                    </div>
                                                </a>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <!-- button start -->
                                        <?php if ($settings['ms_' . $control_id_2 . '_button_show'] == 'yes') : ?>
                                            <div class="ms-app-btn mb-30">
                                                <a <?php echo $this->get_render_attribute_string('ms-button-arg'); ?>>
                                                    <div class="app-icon mr-10">
                                                        <span>
                                                    ...
                                                    <div class="app-content">
                                                        <span><?php echo esc_html__('Download on the', 'mscore'); ?></span>
                                                        <p><?php echo $settings['ms_' . $control_id_2 . '_text']; ?></p>
                                                    </div>
                                                </a>
                                            </div>
                                        <?php endif; ?>
                            ...
                            <?php if (!empty($ms_app_image_url)) : ?>
                                <div class="col-lg-6">
                                    <div class="ms-cta-thumb">
                                        <span class="ms-cta-thumb-mobile"></span>
                                        <img src="<?php echo esc_url($ms_app_image_url); ?>" alt="<?php echo esc_attr($ms_app_image_alt); ?>">
                                    </div>
                                    <span class="ms-cta-thumb-gradient"></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
$widgets_manager->register(new MS_App_Download());
